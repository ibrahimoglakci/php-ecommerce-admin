				...
				if($veriler!=false)
				{
					...
					for($i=0;$i<count($veriler);$i++)
					{
                      ...
                      <label class="custom-control-label" for="customSwitch3<?=$veriler[$i]["ID"]?>"></label>
                          ...
                          <td>
                          <a href="<?=SITE?>duzenle/<?=$kontrol[0]["tablo"]?>/<?=$veriler[$i]["ID"]?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i> Düzenle</a>
                          <a href="<?=SITE?>resimler/<?=$kontrol[0]["tablo"]?>/<?=$veriler[$i]["ID"]?>" class="btn btn-success btn-sm"><i class="fas fa-cog"></i> Resim Yönetimi</a>
                          <a href="<?=SITE?>sil/<?=$kontrol[0]["tablo"]?>/<?=$veriler[$i]["ID"]?>" class="btn btn-danger btn-sm silmeAlani">i class="fas fa-times-circle"></i> Kaldır</a>
                          </td>
                        </tr>
                        <?php
					}
