  ...
  function secenekEkleme(varyasyonID, varyasyonAdi)
    {
      ...
      .then((value) => {
        ...
        {   
          $(".secenekler_"+varyasyonID).append('<li class="liste'+listeSira+'">'+value+'<a class="btn btn-sm btn-danger" style="color:#fff;" onclick="secenekSil('+listeSira+');"><i class="fas fa-trash-alt"></i></a><input type="hidden" name="secenek'+varyasyonID+'[]" value="'+value+'"/></li>')           
